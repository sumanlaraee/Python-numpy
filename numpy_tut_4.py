...
#b/c there are two rows so i can make two divisions only 
...
b= R>4
b   #boolean results will be given 


# In[47]:


R[b]     # array having index itself array   where it finds true return that ina single array form 


# In[49]:


R[b]=-1   # those elements which are greater than 4 set to -1 
R         #this is all about power numpy keeps 
